...
function playUser(){
    mark = gameBoard.addEventListener('click', event => userClickHandler(event), {once:true});
    
    
    gameBoard.removeEventListener('click', event => userClickHandler(event));
    
    return
}
function userClickHandler(event, mark){
